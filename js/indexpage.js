...
new fullpage('#fullpage', {
	...
	afterLoad: function(origin, destination, direction){
        if(destination.index == 0){
            ...
            $("#page_nav ul li:nth-child(1) img").attr('src','./images/one_white.png');
            $("#page_nav ul li:nth-child(1) a").css({"color":"#fff","transition": "all 0.7s"});

            $("#page_nav ul li:nth-child(2) img").attr('src','./images/one_gray.png');
            $("#page_nav ul li:nth-child(2) a").css({"color":"#707070","transition": "all 0.7s"});

            $("#page_nav ul li:nth-child(3) img").attr('src','./images/one_gray.png');
            $("#page_nav ul li:nth-child(3) a").css({"color":"#707070","transition": "all 0.7s"});

            $("#page_nav ul li:nth-child(4) img").attr('src','./images/one_gray.png');
            $("#page_nav ul li:nth-child(4) a").css({"color":"#707070","transition": "all 0.7s"});
            ...
            $("[data-trigger2].visible").removeClass('visible');
            ...
            $("#menu>li").on({
                ...
                $("#logo>h1>a>img").attr("src","./images/logo.png");
                $("#menuwrap").stop().css({
                "height":"272px",
                "background":"#fff",
                "transition": "all .7s",
            ...
            $("#page_nav ul li:nth-child(2) img").attr('src','./images/one_white.png');
            $("#page_nav ul li:nth-child(2) a").css({"color":"#fff","transition": "all 0.7s"});
            ...
            $(".langmenu").css("border","1px solid #fff");
            $(".langmenu>li>a").css("color","#fff");
            $("#lang>a>img:nth-child(1)").attr("src","./images/lang.png");
            $("#lang>a>img:nth-child(2)").attr("src","./images/lang_arr.png");
            $(".chk").css({"background":"#fff"});
            $("#menu>li>a").css({"color":"#fff"});
            ...
            $("#page_nav ul li:nth-child(3) img").attr('src','./images/one_white.png');
            $("#page_nav ul li:nth-child(3) a").css({"color":"#fff","transition": "all 0.7s"});
            ...
            $(".langmenu").css("border","1px solid #5F6368");
            $(".langmenu>li>a").css("color","#5F6368");
            ...
            $("#page_nav ul li:nth-child(4) img").attr('src','./images/one_white.png');
            $("#page_nav ul li:nth-child(4) a").css({"color":"#fff","transition": "all 0.7s"});
            ...
            $("#page_nav ul li:nth-child(5) img").attr('src','./images/one_white.png');
            $("#page_nav ul li:nth-child(5) a").css({"color":"#fff","transition": "all 0.7s"});
